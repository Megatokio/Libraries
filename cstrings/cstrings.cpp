/*	Copyright  (c)	Günter Woigk 1995 - 2021
...
#ifdef DEBUG
void test_hexstr_xxx()
{
	// no need to execute this test ... just see whether the compiler is happy:

	{char n=0x12;		assert(eq(hexstr(n,2),"12"));}
	{uchar n=0x12;		assert(eq(hexstr(n,2),"12"));}
	{schar n=0x12;		assert(eq(hexstr(n,2),"12"));}
	{short n=0x123;		assert(eq(hexstr(n,4),"0123"));}
	{ushort n=0x123;	assert(eq(hexstr(n,4),"0123"));}
	{int n=0x123456;	assert(eq(hexstr(n,6),"123456"));}
	{uint n=0x123456;	assert(eq(hexstr(n,6),"123456"));}
	{long n=0x123456789;	assert(eq(hexstr(n,10),"0123456789"));}
	{ulong n=0x123456789;	assert(eq(hexstr(n,10),"0123456789"));}
	{llong n=0x123456789;	assert(eq(hexstr(n,10),"0123456789"));}
	{ullong n=0x123456789;	assert(eq(hexstr(n,10),"0123456789"));}

	{int8 n=0x12;		assert(eq(hexstr(n,2),"12"));}
	{uint8 n=0x12;		assert(eq(hexstr(n,2),"12"));}
	{int16 n=0x123;		assert(eq(hexstr(n,4),"0123"));}
	{uint16 n=0x123;	assert(eq(hexstr(n,4),"0123"));}
	{int32 n=0x123456;	assert(eq(hexstr(n,6),"123456"));}
	{uint32 n=0x123456;	assert(eq(hexstr(n,6),"123456"));}
	{int64 n=0x123456789;	assert(eq(hexstr(n,10),"0123456789"));}
	{uint64 n=0x123456789;	assert(eq(hexstr(n,10),"0123456789"));}

	{enum Foo : ushort { a,b,c,foo=0x123 }; assert(eq(hexstr(foo,4),"0123"));}
	{enum Foo : uint   { a,b,c,foo=0x123 }; assert(eq(hexstr(foo,4),"0123"));}
	{enum Foo : ulong  { a,b,c,foo=0x123 }; assert(eq(hexstr(foo,4),"0123"));}
}
#endif
