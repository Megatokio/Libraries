...
*/
inline int gif_hash_key(uint32 key) { return ((key >> 12) ^ key) & HT_KEY_MASK; }
...
*/
void GifEncoder::writePixelmap(int bits_per_pixel, const Pixelmap& pm) THF
{
...
*/
void GifEncoder::writeImage(Pixelmap* pmap, const Colormap* cmap) THF
{
