...
char* TempMemPool::alloc( int bytes ) throws
{
...
char* TempMemPool::allocMem( int bytes ) throws
{
    char* p = alloc(bytes);
...
*/
TempMemPool* TempMemPool::getPool() throws
{
    if(virgin) init();
...
*/
TempMemPool* TempMemPool::getXPool() throws
{
