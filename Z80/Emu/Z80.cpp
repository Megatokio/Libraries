// Copyright (c) 1996 - 2021 kio@little-bat.de
...
Word Z80::peek2 (Address addr) const noexcept
{
...
void Z80::copyBufferToRam (uint8 const* q, Address z, uint16 cnt) noexcept
{
...
void Z80::copyBufferToRam (CoreByte const* q, Address z, uint16 cnt) noexcept
{
	uint16 n = CPU_PAGESIZE - (z&CPU_PAGEMASK);
	do
	{
...
inline
Z80::CpuCycle Z80::handle_update (CpuCycle cc, CpuCycle cc_next_update)
{
