...
enum CodesED
{
	...
	IN0_D_xN = ED10, 	OUT0_xN_D = ED11, TST_D = ED14,
	IN0_E_xN = ED18, 	OUT0_xN_E = ED19, TST_E = ED1C,
	IN0_H_xN = ED20, 	OUT0_xN_H = ED21, TST_H = ED24,
	IN0_L_xN = ED28, 	OUT0_xN_L = ED29, TST_L = ED2C,
